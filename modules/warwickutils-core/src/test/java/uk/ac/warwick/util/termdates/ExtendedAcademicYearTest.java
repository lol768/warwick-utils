...
public class ExtendedAcademicYearTest {

    @Test
    public void sanityCheck2011() throws Exception {
        ExtendedAcademicYear year = ExtendedAcademicYear.starting(2011);
    ...
    public void sanityCheck2017() throws Exception {
        ExtendedAcademicYear year = ExtendedAcademicYear.starting(2017);
    ...
    public void sanityCheckData() throws Exception {
        for (int startYear = 2006; startYear <= 2024; startYear++) {
            ExtendedAcademicYear year = ExtendedAcademicYear.starting(startYear);
            assertEquals(year, ExtendedAcademicYear.forDate(LocalDate.of(startYear + 1, Month.APRIL, 23)));
            assertEquals(year, ExtendedAcademicYear.parse(Integer.toString(startYear).substring(2) + "/99")); // end year is ignored anyway
            ...
            assertTrue("Should have at least 61 weeks", year.getAcademicWeeks().size() >= 61);
            assertTrue("Should have at most 62 weeks", year.getAcademicWeeks().size() <= 62);
            ...
            assertTrue("Last week should always end after 25/09", year.getAcademicWeeks().get(year.getAcademicWeeks().size() - 1).getDateRange().getEndInclusive().isAfter(LocalDate.of(startYear + 1, Month.SEPTEMBER, 25)));
    ...
    public void legacyCompatible() throws Exception {
        ExtendedAcademicYear year = ExtendedAcademicYear.starting(2006);
    ...
    public void enoughDates() throws Exception {
        ...
        ExtendedAcademicYear now = ExtendedAcademicYear.forDate(LocalDate.now());
        for (AcademicYear year : now.yearsSurrounding(0, 3)) {
            assertTrue(year instanceof ExtendedAcademicYear);
    ...
    public void getAcademicWeeksForYear() throws Exception {
        ExtendedAcademicYear year = ExtendedAcademicYear.forDate(LocalDate.of(2007, Month.APRIL, 23));
        assertEquals(61, year.getAcademicWeeks().size());
    ...
    public void getAcademicWeeksForYear2014() throws Exception {
        ...
        ExtendedAcademicYear year = ExtendedAcademicYear.forDate(LocalDate.of(2014, Month.NOVEMBER, 1));
        assertEquals(62, year.getAcademicWeeks().size());
    ...
    public void getAcademicWeeksForYear2015() throws Exception {
        ExtendedAcademicYear year = ExtendedAcademicYear.forDate(LocalDate.of(2015, Month.NOVEMBER, 1));
        assertEquals(62, year.getAcademicWeeks().size());
    ...
    public void sbtwo3948() throws Exception {
        ...
        ExtendedAcademicYear year = ExtendedAcademicYear.forDate(monday);
