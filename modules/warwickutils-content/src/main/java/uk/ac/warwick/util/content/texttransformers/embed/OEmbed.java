...
public class OEmbed extends SingularCacheEntryFactory<OEmbedRequest, OEmbedResponse> {
    private static final String CACHE_NAME = "OEmbedCache";
    
    private static final Logger LOGGER = Logger.getLogger(OEmbed.class);
