...
public class TextileTest extends TestCase {
	...
	public final void testRegex() throws Exception {
		...
		compare(longChinesePost, tex.apply(new MutableContent(this.parser, longChinesePost)).getContent());
...
//	}
	...
	public final void testRemoveLeadingNbsp() {
		...
		assertEquals(expected,new RemoveLeadingNbspTransformer().apply(new MutableContent(this.parser, source)).getContent());
	}
