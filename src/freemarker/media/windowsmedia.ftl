...
height='${(height?default(300)?number + 46)?c}'
>
...
<div align="${align}"><div id="video_${uniqueId?c}" style="border: 1px solid #999; width: ${width?default(400)?number?c}px; height: ${(height?default(300)?number + 46)?c}px; background: url(${previewimage}) center center no-repeat;"
