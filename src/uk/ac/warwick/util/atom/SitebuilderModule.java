...
import uk.ac.warwick.util.web.bind.TrimAndEscapeStringPropertyEditor;
...
public interface SitebuilderModule extends Module {
    ...
    Factory<TrimAndEscapeStringPropertyEditor> STRING_PROPERTY_EDITOR_FACTORY = new Factory<TrimAndEscapeStringPropertyEditor>() {
        public TrimAndEscapeStringPropertyEditor create() {
            return new TrimAndEscapeStringPropertyEditor();
        }
    };
