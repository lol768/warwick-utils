...
/**
 * Constructs Uris from inputs. Note that the builder will only automatically
 * encode query parameters that are added. Other parameters must be encoded
 * explicitly.
 */
public final class UriBuilder {
    ...
    /**
     * Assigns the specified query string as the query portion of the uri,
     * automatically decoding parameters to populate the parameter map for calls
     * to getParameter.
     */
    ...
    public UriBuilder overrideQuery(String str) {
        ParamString override = new ParamString(str);
        for (Entry<String, List<String>> entry : override.params.entrySet()) {
    ...
    /**
     * @return The fragmentParameters part of the uri, separated into component
     *         parts.
     */
    ...
    /**
     * Utility method for joining key / value pair parameters into a url-encoded
     * string.
     */
    public static String joinParameters(Map<String, List<String>> query) {
        ...
        for (Map.Entry<String, List<String>> entry: query.entrySet()) {
            String name = HttpUtils.utf8Encode(entry.getKey());
            for (String value: entry.getValue()) {
                ...
                buf.append(name).append('=').append(HttpUtils.utf8Encode(value));
            }
        }
        return buf.toString();
    }
    ...
    public static Map<String, List<String>> splitParameters(String query) {
        ...
        while (paramMatcher.find()) {
            String name = HttpUtils.utf8Decode(paramMatcher.group(1));
            String value = HttpUtils.utf8Decode(paramMatcher.group(2));
    ...
    private static final class ParamString {
        ...
        /**
         * Assigns the specified query string as the query portion of the uri,
         * automatically decoding parameters to populate the parameter map for
        ...
        /**
         * @return The first queryParameters parameter value with the given
         *         name.
         */
