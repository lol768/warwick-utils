...
/**
 * Static class with helpers to manage serialization of a Document. Binds an
 * HtmlSerializer to a Document as user data, and pulls it out to achieve actual
 * serialization.
 */
public class HtmlSerialization {
     ...
     */
    public static void printStartElement(Element elem, Writer output, boolean withXmlClose) throws IOException {
        printStartElement(elem.getTagName(), elem.getAttributes(), output, withXmlClose);
    }

    public static void printStartElement(String tagName, NamedNodeMap attributes, Writer output, boolean withXmlClose)
            throws IOException {
