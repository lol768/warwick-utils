package uk.ac.warwick.util.content.cleaner.html5;
 ...
 * normally provided with HTML 5 and 4.01 are given, plus some that are IE-specific
...
public class HTML5Schema extends Schema implements HTML5Models {
    ...
    public static final boolean IS_POPULATED = false;
